...
jsPsych.plugins["audio-keyboard-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      trial_ends_after_audio_and_time: {
        type: jsPsych.plugins.parameterType.INTEGER,
        pretty_name: 'Trial ends after audio and some specified amount of time',
        default: false,
        description: 'If true, then the trial will end as soon as the audio file finishes playing and the specified amoutn of time is reached.'
      },
    }
  }
